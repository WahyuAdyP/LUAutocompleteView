...
open class LUAutocompleteView: UIView {
    ...
    /// Spacing between textfield and tableview result
    public var spacingResult: CGFloat = 0
    ...
    private func setupConstraints() {
        ...
        let constraints = [
            ...
            topAnchor.constraint(equalTo: textField.bottomAnchor, constant: spacingResult),
            heightConstraint!
        ]
